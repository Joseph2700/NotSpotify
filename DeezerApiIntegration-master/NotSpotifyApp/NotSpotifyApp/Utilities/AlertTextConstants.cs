...
namespace NotSpotifyApp.Utilities
{
    public class AlertTextConstants
    {
        ...
        public const string EmptyField = "Seems like you left an empty space, fill it out and then try again.";
    }
}
